...
var header = {
  ...
  salary: '600$ в місяц',
  address: 'м. Кукуєво, вул Пушкіна, дім Колотушкіна, 42',
}

var footer = {
  social: {
    email: {
      text: 'kostya@mail.com',
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      ...
      educations: [
        {
          name: 'Донецький університет',
          isEnd: true,
        },
        {
          name: 'Киїйвський національний інститут',
          isEnd: false,
        },
        {
          name: 'Чернівецький технікум',
          isEnd: false,
        },
        {
          name: 'Коледж №55',
          ...
          projects: [
            {
              name: 'Resume',
              url: 'https://it-brains.com.ua/',
              about: 'Let me speak from my heart!',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                ...
                {
                  name: 'Frontground verification and SEO development',
                },
              ],
              stackAmount: 5,
              awardAmount: 7,
